...
import { ReportPage } from "../../06_IMPLEMENTATION/apps/web/src/pages/ReportPage.tsx";
...
vi.mock("../../06_IMPLEMENTATION/apps/web/src/lib/api.ts", () => ({
...
describe("ReportPage", () => {
  ...
  it("renders summary totals and risk badges", async () => {
    ...
    expect(screen.getByText("Won celkom").previousElementSibling).toHaveTextContent("€ 17 000");
  });
});